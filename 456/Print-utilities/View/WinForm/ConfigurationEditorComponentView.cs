...
namespace Macro.ImageViewer.Utilities.Print.View.WinForm
{
    ...
    [ExtensionOf(typeof(DicomPrinterConfigurationEditorViewExtensionPoint))]
   public class ConfigurationEditorComponentView : WinFormsView, IApplicationComponentView
    {
        private IDicomPrinterConfigurationEditorComponent _component;
        private ConfigurationEditorComponentControl _componentControl;
        ...
        public override object GuiElement
        {
            get
            {
                ...
                {
                    _componentControl = new ConfigurationEditorComponentControl(_component);
                }
