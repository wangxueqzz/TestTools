...
namespace Macro.ImageViewer.Utilities.Print.View.WinForm
{
    ...
    [ExtensionOf(typeof(DicomPrinterEditorViewExtensionPoint))]
    public  class EditorComponentView : WinFormsView, IApplicationComponentView
    {
        private IDicomPrinterEditorComponent _component;
        private EditorComponentControl _componentControl;
        ...
        public override object GuiElement
        {
            get 
            {
                ...
                {
                    _componentControl=new EditorComponentControl(_component);
                }
