...
namespace Macro.ImageViewer.Utilities.Print.Dicom.Preview.View.Winforms
{
    ...
    /// </summary>
    [ExtensionOf(typeof(PrintPreviewTileViewExtensionPoint))]
    public class PrintTileView : WinFormsView, IView
    {
        private PrintViewTile _tile;
        private PrintTileControl _tileControl;
		...
		public override object GuiElement
        {
            get
            {
                ...
                {
                    _tileControl = new PrintTileControl(this.Tile, this.ParentRectangle, this.ParentImageBoxInsetWidth);
                }
                return _tileControl;
            }
        }
