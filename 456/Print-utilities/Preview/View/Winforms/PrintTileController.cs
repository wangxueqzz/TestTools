...
namespace Macro.ImageViewer.Utilities.Print.Dicom.Preview.View.Winforms
{
    ...
    /// <remarks>
    /// <para>
    /// - The <see cref="PrintTileController"/> receives messages from the view layer, interprets them, and allows the appropriate domain objects to handle
    ...
    public sealed class PrintTileController : IMouseInformation, IDisposable
    {
        ...
        private class MouseWheelManager
        {
            ...
            private PrintTileController _captureTileController;
        ...
        private readonly PrintViewTile _tile;
        ...
        [ThreadStatic]
        private static KeyboardButtonMessage _key = new KeyboardButtonMessage(XKeys.None, KeyboardButtonMessage.ButtonActions.Down);
        ...
        /// <summary>
        /// The <see cref="ITile"/> that is controlled by this <see cref="PrintTileController"/>.
        /// </summary>
        /// <remarks>
