...
namespace Macro.ImageViewer.Utilities.Print.Dicom.Preview.View.Winforms
{
	...
	public sealed class StandardTrackSliderVisualStyle : TrackSliderVisualStyle
	{
		...
		{
            Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream(string.Format("Macro.ImageViewer.Utilities.Print.Dicom.Preview.View.Winforms.TrackSliderResources.{0}.png", key));
			if (stream == null)
