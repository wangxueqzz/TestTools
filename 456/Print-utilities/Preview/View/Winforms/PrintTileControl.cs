...
namespace Macro.ImageViewer.Utilities.Print.Dicom.Preview.View.Winforms
{
    ...
    /// </summary>
    public partial class PrintTileControl : UserControl
    {
        #region Private fields

        private PrintViewTile _tile;
        private PrintTileInputTranslator _inputTranslator;
        private PrintTileController _tileController;
        ...
        [ThreadStatic]
        private static readonly List<PrintTileControl> _tilesToRepaint = new List<PrintTileControl>();
        ...
        public void SetParentImageBoxRectangle(Rectangle parentImageBoxRectangle, int parentImageBoxBorderWidth, bool suppressDraw)
        {
            ...
            int left = (int)(_tile.NormalizedRectangle.Left * insetImageBoxWidth + PrintViewTile.InsetWidth);
            int top = (int)(_tile.NormalizedRectangle.Top * insetImageBoxHeight + PrintViewTile.InsetWidth);
            int right = (int)(_tile.NormalizedRectangle.Right * insetImageBoxWidth - PrintViewTile.InsetWidth);
            int bottom = (int)(_tile.NormalizedRectangle.Bottom * insetImageBoxHeight - PrintViewTile.InsetWidth);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                PrintTileControl tileToRepaint = _tilesToRepaint[0];
